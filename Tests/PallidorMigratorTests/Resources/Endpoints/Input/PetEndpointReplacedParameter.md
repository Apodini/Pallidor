...
Responses:
    - 405: Invalid input
*/
public static func updatePetWithForm(betterId: Double, name: String, status: String, authorization: HTTPAuthorization = NetworkManager.authorization!, contentType: String? = NetworkManager.defaultContentType) -> AnyPublisher<String, Error> {
var path = NetworkManager.basePath! + "/pet/{betterId}"
    path = path.replacingOccurrences(of: "{betterId}", with: betterId.description)
